"""
Este archivo limpiara los siguiente dos datos crudos:
* Data/Crudo/top40_cierre_aju.csv: El "Cierre Ajustado" de las 40 companias en SPLAC
* Data/Crudo/top40_completo.csv: todos los componentes de las 40 companias dentro SPLAC
"""
...
df.to_csv(
    f'{data_path}/Limpio/top40_cierre_aju.csv',
    index=True,
    encoding='utf-8')
...
#### Saving
df_complete.to_csv(
    f'{data_path}/Limpio/top40_completo.csv',
    index=True,
    encoding='utf-8')
