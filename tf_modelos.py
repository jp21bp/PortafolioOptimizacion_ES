"""
Este archivo creara el procesamiento de datos y los modelos de TensorFlow

Recordar: El ratio sharpe se esta maximizando
    Donde este ratio sera parte de la funcion de perdidad del modelo

Razon para maximizar ratio Sharpe y no retornos:
    El ratio considera la volatilidad de los retornos
"""
#### Importing libraries
import pandas as pd
import numpy as np
